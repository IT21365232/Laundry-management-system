...
<div class="col-lg-3 col-md-6 footer-links"></div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              No 16, <br>
              Rajakeeya Mawatha,Colombo 07,<br>
              Sri Lanka <br>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>The Event</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
        All the links in the footer should remain intact.s
  ...
  <script src="assets/vendor/menu/menu.js"></script>
